function [points_1, points_2]=sift_match(image1, image2)
...
points_1 = zeros(2, size(matched_points,1));
points_2 = zeros(2, size(matched_points,1));
for i=1:size(matched_points,1)
    points_1(:,i) = image1.keypoints(matched_points(i,1),1:2);
    points_2(:,i) = image2.keypoints(matched_points(i,2),1:2);
end
